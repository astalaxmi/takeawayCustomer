...
class AppGroceries3CheckoutScreen extends StatelessWidget {
  AppGroceries3CheckoutScreen({Key? key})
      : super(
          key: key,
        );
  ...
  /// Section Widget
  Widget _buildToorDhal(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          CustomImageView(
            imagePath: ImageConstant.imgRectangle3257x60,
            height: 57.v,
            width: 60.h,

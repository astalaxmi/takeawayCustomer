...
class AppMedicines4CheckoutScreen extends StatelessWidget {
  const AppMedicines4CheckoutScreen({Key? key})
      : super(
          key: key,
        );
  ...
  /// Section Widget
  Widget _buildOrderInProgress(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(
        left: 16.h,
        right: 33.h,

...
class AppTheatre3CheckoutScreen extends StatelessWidget {
  AppTheatre3CheckoutScreen({Key? key})
      : super(
          key: key,
        );
  ...
  /// Section Widget
  Widget _buildCocaCola(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          CustomImageView(
            imagePath: ImageConstant.imgRectangle322,
            height: 57.v,
            width: 60.h,
